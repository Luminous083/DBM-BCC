...
L["If checked, mechanostriders will be muted."] = "勾选后，静音机械陆行鸟坐骑。"
...
L["If checked, mechanostriders will be muted."] = "勾選後，機械陸行鳥將被靜音。"
...
L["If checked, mechanostriders will be muted."] = "Если флажок установлен, механодолгоноги не будут издавать звуков."
...
L["Leatrix Plus needs to be updated with the flight details.  Press CTRL/C to copy the flight details below then paste them into a ticket at github.com/leatrix or a message to leatrix via CurseForge website or an email to flight@leatrix.com.  When your report is received, Leatrix Plus will be updated and you will never see this window again for this flight."] = "Leatrix Plus необходимо обновить информацию о маршруте. Нажмите кнопки [CTRL]+[C], чтобы скопировать приведенные ниже данные о рейсе, затем вставьте их в обращение на сайте github.com/leatrix или в сообщение для leatrix через сайт CurseForge, либо в письмо, которое затем нужно будет отправить на flight@leatrix.com. Когда ваш отчет будет получен, Leatrix Plus будет обновлен, и вы больше никогда не увидите это окно для данного маршрута."
